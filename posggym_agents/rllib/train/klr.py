...
def get_symmetric_klr_algorithm(
    ...
    # -1 for random policy
    num_algorithms = len(igraph.get_agent_policy_ids(None)) - 1
    ...
    for train_policy_id in igraph.get_agent_policy_ids(None):
        connected_policies = igraph.get_all_policies(None, train_policy_id, None)
        ...
        igraph.update_policy(None, train_policy_id, algorithm_k_weights)
