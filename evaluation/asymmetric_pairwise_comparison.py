...
def get_asymmetric_pairwise_exp_params(
    env_id: str,
    policy_ids: Optional[List[List[str]]],
    init_seed: int,
    num_seeds: int,
    num_episodes: int,
    ...
    if policy_ids is None:
        policy_ids = [[] for _ in env.possible_agents]
        policy_specs = get_all_env_policies(env_id, include_generic_policies=True)
...
def main(args):  # noqa
    ...
    exp_params_list = get_asymmetric_pairwise_exp_params(
        env_id=args.env_id,
